...
const IconVitest = () => {
  // prettier-ignore
  return (
    <svg width="1em" height="1em" viewBox="0 0 165 165" fill="none" xmlns="http://www.w3.org/2000/svg">
