...
test("find todos", async ({ page }) => {
  ...
  const grepCmd = `grep -riI "${pattern}" --exclude-dir="node_modules" --exclude-dir="lexical" --exclude-dir="playwright-report" --exclude="package-lock.json" --exclude="todos.spec.js" .`;
